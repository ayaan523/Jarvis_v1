...
class ChatTab(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.status_label.setStyleSheet("color: #E5C158; font-size: 12px; font-weight: bold;")
        ...
        input_bar.setStyleSheet("background-color: transparent; border-top: 1px solid rgba(255, 215, 0, 0.2);")
        ...
        self.user_input.setPlaceholderText("Ask JARVIS anything...")
