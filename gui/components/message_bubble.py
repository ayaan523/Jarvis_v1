...
class MessageBubble(QFrame):
    ...
    def _apply_style(self):
        ...
        if self.is_thinking:
            ...
            border_radius = "12px"
            text_color = "#E5C158"
            border_style = "1px solid rgba(255, 215, 0, 0.25)"
        elif is_user:
            bg_color = "#8B0000"  # Crimson Red
            border_radius = "18px 18px 4px 18px"
            text_color = "#FFD700"  # Gold Text
            border_style = "1px solid #FFD700"
        else:
            bg_color = "#2A050A"  # Deep Crimson Surface
            border_radius = "18px 18px 18px 4px"
            text_color = "#FFF8E7"  # Warm White
            border_style = "1px solid rgba(255, 215, 0, 0.4)"
